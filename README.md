...
This repository hosts the generated OpenGL 4.6 binding for Erlang and
Elixir. Only the core profile functions selected for this target are
exposed through the `gl` module. Loading custom OpenGL functions is not
supported.
...
[API reference](https://erlangsters.github.io/opengl-4.6/), and the
