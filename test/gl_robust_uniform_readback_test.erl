-module(gl_robust_uniform_readback_test).
-include_lib("eunit/include/eunit.hrl").

robust_uniform_readback_test() ->
    ...
    {ok, [0.25, 0.5, 0.75, 1.0]} =
        gl:get_n_uniform(f, Program, FloatLocation, 4),
    {ok, [-1, 2, -3, 4]} =
        gl:get_n_uniform(i, Program, IntLocation, 4),
    {ok, [1, 2, 3, 4]} =
        gl:get_n_uniform(ui, Program, UintLocation, 4),
